...
See the [publication](https://doi.org/10.1371/journal.pone.0286761) for tested and selected models and parameters, the reasoning behind the model selection, and employed datasets for training.
